...
eig1600 = read_from_file("../Eigs1600.txt")
eig100 = read_from_file("../Eigs100.txt")
eig0 = read_from_file("../Eigs0.txt")
...
line1, = ax.plot(index, eig1600.transpose(), color = 'blue' ,label="k = 1600", lw = linge_width)
