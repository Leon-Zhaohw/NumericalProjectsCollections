...
{
public:
  FLUID_3D_MIC(int xRes, int yRes, int zRes, int amplify, const bool use_two_phase_smoke, 
               ...
               const std::string density_folder, const double dt,
...
protected:  
  ...
  VECTOR3_FIELD_3D vtemp1;
  VECTOR3_FIELD_3D vtemp2;
  ...
  bool move_obstacle_;
  void SetSideObstacles();
  
  std::vector<Particle3D> particles_;
  const int num_particles_ = 5000;
