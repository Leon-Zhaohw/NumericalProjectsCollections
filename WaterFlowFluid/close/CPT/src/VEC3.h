...
// helpers from drawing double precision values
#define my_glNormal3fv(x) { float v[3] = {(x)[0],(x)[1],(x)[2]}; glNormal3fv(v); }
#define my_glVertex3fv(x) { float v[3] = {(x)[0],(x)[1],(x)[2]}; glVertex3fv(v); }
