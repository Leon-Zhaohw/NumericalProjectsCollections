...
//////////////////////////////////////////////////////////////////////////////////////////
static inline float WNoiseDx(VEC3F p, float* data) { 
...
//////////////////////////////////////////////////////////////////////////////////////////
static inline float WNoiseDy(VEC3F p, float* data) { 
  int c[3], mid[3], n=noiseTileSize; 
  float w[3][3], t, result =0;
...
//////////////////////////////////////////////////////////////////////////////////////////
static inline float WNoiseDz(VEC3F p, float* data) { 
  int c[3], mid[3], n=noiseTileSize; 
  float w[3][3], t, result =0;
...
//////////////////////////////////////////////////////////////////////////////////////////
VEC3F WVelocity(VEC3F orgPos)
{
  // arbitrarily offset evaluation points
  const VEC3F p1 = orgPos + VEC3F(NOISE_TILE_SIZE/2,0,0);
  const VEC3F p2 = orgPos + VEC3F(0,NOISE_TILE_SIZE/2,0);
  const VEC3F p3 = orgPos + VEC3F(0,0,NOISE_TILE_SIZE/2);

  const float f1y = WNoiseDy(p1, noiseTile);
  const float f1z = WNoiseDz(p1, noiseTile);

  const float f2x = WNoiseDx(p2, noiseTile);
  const float f2z = WNoiseDz(p2, noiseTile);

  const float f3x = WNoiseDx(p3, noiseTile);
  const float f3y = WNoiseDy(p3, noiseTile);
...
//////////////////////////////////////////////////////////////////////////////////////////
// Evaluate derivatives at a specific scale
//////////////////////////////////////////////////////////////////////////////////////////
VEC3F WVelocity(VEC3F orgPos, int scale)
{
  orgPos *= scale;
  return WVelocity(orgPos);
}

//////////////////////////////////////////////////////////////////////////////////////////
// Get Kolmogorov turbulence
//////////////////////////////////////////////////////////////////////////////////////////
VEC3F WKolmogorov(VEC3F position)
{
  ...
  {
    velocity += WVelocity(position) * amplitude;
