...
public:
    ...
    template<class T_VECTOR> typename boost::enable_if<boost::mpl::and_<IS_SAME<T,typename T_VECTOR::ELEMENT>,INTS_EQUAL<T_VECTOR::m,2> >,VECTOR&>::type
    ...
    {STATIC_ASSERT((mpl::and_<mpl::less_equal<mpl::int_<1>,mpl::int_<d1> >,mpl::less_equal<mpl::int_<d2>,mpl::int_<2> > >::value));
    ...
    {MATRIX<T,1,2> result;result(1,1)=-y;result(1,2)=x;return result;}
...
operator>>(std::istream& input,VECTOR<T,2>& v)
{return input>>v.x>>v.y;}

template<class T> inline std::ostream&
operator<<(std::ostream& output,const VECTOR<T,2>& v)
