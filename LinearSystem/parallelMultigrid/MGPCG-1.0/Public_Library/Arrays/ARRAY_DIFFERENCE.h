...
template<class T_ARRAY1,class T_ARRAY2> struct IS_ARRAY<ARRAY_DIFFERENCE<T_ARRAY1,T_ARRAY2> >:public mpl::true_{};
template<class T_ARRAY1,class T_ARRAY2> struct IS_ARRAY_VIEW<ARRAY_DIFFERENCE<T_ARRAY1,T_ARRAY2> >:public mpl::true_{};
...
class ARRAY_DIFFERENCE:public ARRAY_EXPRESSION<typename SUM<typename T_ARRAY1::ELEMENT,typename T_ARRAY2::ELEMENT>::TYPE,ARRAY_DIFFERENCE<T_ARRAY1,T_ARRAY2>,typename T_ARRAY1::INDEX>
{
    ...
    typedef typename SUM<T1,T2>::TYPE T_DIFFERENCE;
public:
