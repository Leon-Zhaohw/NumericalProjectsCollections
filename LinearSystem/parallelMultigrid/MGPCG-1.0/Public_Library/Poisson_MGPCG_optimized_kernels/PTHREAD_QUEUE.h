//#####################################################################
// Copyright 2007-2010, Andrew Selle, Eftychios Sifakis, Aleka McAdams
...
public:
    ...
    ~PTHREAD_QUEUE()
    {
        EXITER* exiter = new EXITER[number_of_threads];
        for(int i=0;i<number_of_threads;i++) Queue(&exiter[i]);
