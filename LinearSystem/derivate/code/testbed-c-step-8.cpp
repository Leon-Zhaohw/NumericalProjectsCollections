...
struct HELPER
{
    ...
    void fill()
    {
        ...
        du.set("ir",inv_nv*id("ir")+dinv_nv("r")*v("i"));
        ...
        ddu.set("irs",dinv_nv("s")*id("ir")+ddinv_nv("rs")*v("i")+dinv_nv("r")*id("is"));
