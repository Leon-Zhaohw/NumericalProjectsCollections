...
struct HELPER
{
    ...
    void fill()
    {
        ...
        psi.set("",Z+dZ("i")*k("i")+ddZ("ij")*k("i")*k("j")/2);
        ...
        ddpsi.set("rs",
            ddZ("rs")
            +vdddZ("rs")*s*(1-s)*(2-s)
            +vvdddZ("r")*ds("s")*(1-s)*(1-s)*3/2
            +vvdddZ("s")*ds("r")*(1-s)*(1-s)*3/2
            +vvvdddZ*dds("rs")*(1-s)*(1-s)/2
            -vvvdddZ*ds("r")*ds("s")*(1-s)
            +vvddddZ("rs")*s*s*(1-s)*(1-s)/2
            +vvvddddZ("r")*ds("s")*s*(1-s)*(1-s)/2
            +vvvddddZ("s")*ds("r")*s*(1-s)*(1-s)/2
            +vvvvddddZ*ds("s")*ds("r")*(1-s)*(1-s)/2
