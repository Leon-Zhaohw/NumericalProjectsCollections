...
struct HELPER
{
    ...
    void fill()
    {
        ...
        dF_bar.set("ijrs",id3("ir")*R_X_inv("sj"));
        dE_bar.set("ijrs",0.5*(id3("kr")*R_X_inv("si")*F_bar("kj")+F_bar("ki")*id3("kr")*R_X_inv("sj")));
        dW.set("rs",A_X*(lambda*dE_bar("iirs")*E_bar("jj") + 2*mu*dE_bar("ijrs")*E_bar("ji")));

        ddE_bar.set("ijrsuv",0.5*(id3("kr")*R_X_inv("si")*id3("ku")*R_X_inv("vj")+id3("ku")*R_X_inv("vi")*id3("kr")*R_X_inv("sj")));
