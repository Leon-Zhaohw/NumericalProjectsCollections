...
struct HELPER
{
    ...
    symbolic_tensor d2,dd2_dN,dd2_dz,ddd2_dN_dN,ddd2_dN_dz,ddd2_dz_dz;
    symbolic_tensor g,dg_dN,dg_dz,ddg_dN_dN,ddg_dN_dz,ddg_dz_dz;
    ...
    void fill()
    {
        ...
        dA_dN.set("r",N("r")/A);
        dd2_dN.set("r",2*d*z("r"));
        dd2_dz.set("r",2*d*N("r"));
        dg_dN.set("r",-g*g*dd2_dN("r"));
        dg_dz.set("r",-g*g*dd2_dz("r"));
        dC_dN.set("r",(3*a*A+2*b/InputArea*A2)*2*N("r"));
        ...
        ddC_dN_dN.set("rs",(3*a*A+2*b/InputArea*A2)*ddA2_dN_dN("rs")+(3*a*dA_dN("s")+2*b/InputArea*2*N("s"))*2*N("r"));
