...
struct HELPER
{
    ...
    void fill()
    {
        ...
        ddpsi.set("rs",
            ...
            +vvddZ*ds("r")*ds("s")
            +vddZ("s")*ds("r")*s
            +vvddddZ("km")*dq("ms")*dq("kr")*(1-s)*(1-s)/2
            +vvdddZ("r")*ds("s")*(1-s)*(1-s)/2
            +vvdddZ("s")*ds("r")*(1-s)*(1-s)/2
            +vvvdddZ*dds("rs")*(1-s)*(1-s)/2
            +dddZ("ijk")*dq("kr")*dk("is")*k("j")/2
            +dddZ("ijk")*dq("kr")*k("i")*dk("js")/2
            +dddZ("ijk")*dq("ks")*dk("ir")*k("j")/2
            +ddZ("ij")*dk("ir")*dk("js")/2
            +dddZ("ijk")*dq("ks")*k("i")*dk("jr")/2
            +ddZ("ij")*dk("is")*dk("jr")/2
            +vddZ("i")*ddk("irs")*(1-s)

            +dZ("r")*ds("s")
            +dZ("s")*ds("r")
            +vdZ*dds("rs")
            +vdddZ("jk")*dq("ks")*dq("jr")*(1-s)
            +vddZ("r")*(1-s)*ds("s")
            +vddZ("s")*(1-s)*ds("r")
            +vvddZ*(1-s)*dds("rs")
            +ddZ("ik")*dq("kr")*dk("is")
