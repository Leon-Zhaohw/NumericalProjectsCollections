...
struct HELPER
{
    ...
    void fill()
    {
        ...
        qZ.set("",Z);
        dqZ.set("r",dZ("i")*dq("ir"));
        ddqZ.set("rs",ddZ("ij")*dq("ir")*dq("js")+dZ("i")*ddq("irs"));

        qdZ.set("m",dZ("m"));
        dqdZ.set("mr",ddZ("mi")*dq("ir"));
        ddqdZ.set("mrs",dddZ("mij")*dq("ir")*dq("js")+ddZ("mi")*ddq("irs"));

        qddZ.set("mn",ddZ("mn"));
        dqddZ.set("mnr",dddZ("mni")*dq("ir"));
        ddqddZ.set("mnrs",ddddZ("mnij")*dq("ir")*dq("js")+dddZ("mni")*ddq("irs"));

        k.set("i",h*u("i"));
        dk.set("ir",dh("r")*u("i")+h*du("ir"));
        ddk.set("irs",ddh("rs")*u("i")+dh("r")*du("is")+dh("s")*du("ir")+h*ddu("irs"));
