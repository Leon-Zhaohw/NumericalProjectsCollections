...
public:
	...
	virtual void ann_search(ANNdist,ANNVisit&,ANNGlobal&) = 0;		// tree search
	virtual void ann_pri_search(ANNdist,ANNVisit&,ANNGlobal&) = 0;	// priority search
	virtual void ann_FR_search(ANNdist,ANNVisit&,ANNGlobal&) = 0;	// fixed-radius search
...
public:
	...
	virtual void ann_search(ANNdist,ANNVisit&,ANNGlobal&);			// standard search
	virtual void ann_pri_search(ANNdist,ANNVisit&,ANNGlobal&);		// priority search
	virtual void ann_FR_search(ANNdist,ANNVisit&,ANNGlobal&);		// fixed-radius search
};
