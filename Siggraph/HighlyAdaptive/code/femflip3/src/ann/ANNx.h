...
typedef struct {
	int					ANNkdDim;		// dimension of space (static copy)
	ANNpoint			ANNkdQ;			// query point (static copy)
	double				ANNkdMaxErr;	// max tolerable squared error
	ANNpointArray		ANNkdPts;		// the points (static copy)
