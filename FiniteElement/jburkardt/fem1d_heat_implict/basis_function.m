...
%  Input:
%
%    integer INDEX, the index of the basis function to be evaluated.
%
%    integer ELEMENT, the index of the element in which the points lie.
%
%    real NODE_X(NODE_NUM), the coordinates of nodes.
%
%    integer POINT_NUM, the number of evaluation points.
%
%    real POINT_X(POINT_NUM), the evaluation points.
%
%  Output:
%
%    real B(POINT_NUM), the basis function and its derivative, evaluated
