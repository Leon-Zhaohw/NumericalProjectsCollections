...
%
%    integer ELEMENT_NODE(2,ELEMENT_NUM);
...
%
%    real K_FUN(), a function to evaluate the heat conductivity.
%
%    real RHS_FUN(), a function to evaluate the right hand side.
%
%  Output:
%
%    sparse real A(X_NUM,X_NUM), the finite element stiffness matrix.
%
%    real B(X_NUM), the right hand side.
%
%  Local:
%
%    real BI, DBIDX, the value of some basis function
%    and its first derivative at a quadrature point.
%
%    real BJ, DBJDX, the value of another basis
