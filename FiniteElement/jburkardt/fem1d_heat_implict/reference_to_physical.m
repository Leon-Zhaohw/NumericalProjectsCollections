...
%  Input:
%
%    integer ELEMENT, the index of the element.
%
...
%
%    integer REFERENCE_NUM, the number of points in the reference
%    interval to be transformed.
%
%    real REFERENCE_X(REFERENCE_NUM), the coordinates of the
%    points in the reference interval.
%
%  Output:
%
%    real PHYSICAL_X(REFERENCE_NUM), the coordinates of the
