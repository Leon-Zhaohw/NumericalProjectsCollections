...
%
%    real NODE_XY(2,NODE_NUM), the coordinates of nodes.
%
%    integer ELEMENT_ORDER, the number of nodes used to form one element.
%
...
%
%    integer QUAD_NUM, the number of quadrature points used in assembly.
%
%    integer IB, the half-bandwidth of the matrix.
%
%    real T, the current time.
%
%    real TIME_STEP_SIZE, the size of the time step.
%
%    real U_OLD(NODE_NUM), the finite element
%    coefficients for the solution at the previous time.
%
%    sparse real A(X_NUM,X_NUM), the matrix.
%
%    real B(X_NUM), the right hand side.
%
%  Output:
%
%    sparse real A(X_NUM,X_NUM), the updated matrix.
%
%    real B(X_NUM), the updated right hand side.
%
