...
%
%    integer ELEMENT_NODE(2,ELEMENT_NUM), the nodes belonging to 
%    each element.
%
%    integer QUAD_NUM, the number of quadrature points to use.
%
%    real U_OLD(X_NUM,1), the solution at time T - dt.
%
%  Output:
%
%    real U(X_NUM,1), the solution at time T.
%
