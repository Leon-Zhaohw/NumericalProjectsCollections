function fem1d_bvp_linear_test10 ( )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'FEM1D_BVP_LINEAR_TEST10\n' );
  ...
  for e_log = 0 : e_log_max
    ...
    l2_plot(e_log+1) = l2_error_linear ( n, x, u, @exact10 );

    h1_plot(e_log+1) = h1s_error_linear ( n, x, u, @exact_ux10 );

    mx_plot(e_log+1) = max_error_linear ( n, x, u, @exact10 );
