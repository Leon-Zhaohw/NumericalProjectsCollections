...
%  Input:
%
%    integer IL, the local index of the basis function.
%
%    real X, the evaluation point.
%
%    real XLEFT, XRITE, the endpoints of the interval.
%
%  Output:
%
%    real PHII, PHIIX, the value of the basis function
%    and its derivative.
%
  if ( xleft <= x && x <= xrite )
...
%
%    real F(NU), the right hand side of the linear system.
%
%    INTEGER NU, the number of equations to be solved.
%
%  Output:
%
...
%  Output:
%
%    real U(NU), the finite element coefficients of the
...
%  Input:
%
%    real U(NU), the finite element representation of the
...
%  Output:
%
%    integer N, the updated number of nodes.
%
%    real XN(0:N), the updated nodes.
%
%    integer STATUS, reports status of subdivision.
%    0, a new subdivision was carried out.
%    1, no more subdivisions are needed.
