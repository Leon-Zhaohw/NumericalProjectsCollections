...
%    File <fem_lame2d.m> in $(HOME)/acfk/fem_lame2d/lshape_p1/ and
%                           $(HOME)/acfk/fem_lame2d/lshape_q1/
%    This program and corresponding data-files give Fig. 4 resp. Fig. 5 in
...
[W,M] = u_d(coordinates(DirichletNodes,:),lambda,mu);
