...
// NOTE: This is freely available code that I adapted slightly. Jenkins-Traub
// might be overkill for the quadratic polynomials we are dealing with in this
// spline editor*, but is easily the most robust code out there, and a must for
// the cubic (and especially the degree 6) polynomials encountered for surface
// intersection tests -dh
//
// * All Jenkins-Traub does for quadratic polynomials is use the quadratic equation
// in a way that avoids buffer overflow
//
