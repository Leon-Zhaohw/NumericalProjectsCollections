...
public:
    ...
    void set_all_ranges()
    {
        ...
        stepX_spin->setRange(-1.0, 10.);
        stepW_spin->setRange(-1.0, 10.);
        epsilon_spin->setRange(0, 100);
        frequency_spin->setRange(0, 20);
    ...
    {
        return epsilon_spin->value();
    }
    
    void set_epsilon(const double epsilon)
    {
        epsilon_spin->setValue(epsilon);
    }
