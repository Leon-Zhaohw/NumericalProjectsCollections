...
public:
    ...
    void toggle_view_edge_priority() { m_view_edge_priority = !m_view_edge_priority; }
    ...
    void toggle_activate_simulation() { m_activate_simulation = (m_activate_simulation == 0); }
    
    void toggle_simulation_stage() { m_simulation_stage = (m_simulation_stage+1)%7; }
